...
class Background:
    ...
    def remove_background(self, pred_name):
        if self.predColl[pred_name] is None:
            return
        self.backgrounds[pred_name] = []
        self.backgrounds_value[pred_name] = []
        self.backgrounds_ind[pred_name] = []
